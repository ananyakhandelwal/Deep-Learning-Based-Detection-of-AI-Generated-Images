...
class RealVsAIClassifier:
    ...
    def create_model(self):
        ...
        # ResNet50 specific preprocessing (expects 0-255 inputs)
    ...
    def prepare_data_generators(self, train_dir):
        ...
        train_datagen = ImageDataGenerator(
            ...
            # Note: No rescale needed for ResNet50 preprocess_input
        )
    ...
    def unfreeze_and_finetune(self, train_gen, val_gen):
        ...
        # Freeze all layers except the last stage (conv5_block)
        # ResNet50 has 5 stages: conv1, conv2_block, conv3_block, conv4_block, conv5_block
        # We fine-tune only conv5_block (last residual stage)
        set_trainable = False
    ...
    def train(self, train_gen, val_gen, epochs=15, is_finetuning=False):
        ...
        checkpoint_name = 'ResNet50_best_model_finetuned.keras' if is_finetuning else 'ResNet50_best_model.keras'
    ...
    def plot_results(self, test_gen):
        ...
        ax[1].legend()
        plt.savefig("/kaggle/working/ResNet50_accuracy_loss.png", dpi=300, bbox_inches='tight')
        plt.show()
        ...
        ax[1].legend()
        plt.savefig("/kaggle/working/ResNet50_roc_pr.png", dpi=300, bbox_inches='tight')
        plt.show()

    def save_final(self):
        self.model.save('/kaggle/working/ResNet50_cifake_final.keras')
        print("✓ Model saved as ResNet50_cifake_final.keras")
        self.model.save('/kaggle/working/ResNet50_cifake_final.h5')
        print("✓ Model saved as ResNet50_cifake_final.h5")
