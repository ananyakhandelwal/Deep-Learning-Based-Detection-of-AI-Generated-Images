...
class RealVsAIClassifier:
    ...
    def create_model(self):
        ...
        # EfficientNet specific preprocessing (expects 0-255 inputs)
        ...
        print("✓ Model created (EfficientNetB0 Base Frozen)")
    ...
    def prepare_data_generators(self, train_dir):
        ...
        train_datagen = ImageDataGenerator(
            ...
            # Note: No rescale needed for EfficientNet preprocess_input
        )
    ...
    def unfreeze_and_finetune(self, train_gen, val_gen):
        ...
        # EfficientNet has ~237 layers. Fine-tune the last ~20% of layers
        ...
        print(f"Fine-tuning {trainable_count}/{total_layers} layers")
    ...
    def train(self, train_gen, val_gen, epochs=15, is_finetuning=False):
        ...
        checkpoint_name = 'EfficientNetB0_best_model_finetuned.keras' if is_finetuning else 'EfficientNetB0_best_model.keras'
    ...
    def plot_results(self, test_gen):
        ...
        ax[1].legend()
        plt.savefig("/kaggle/working/EfficientNetB0_accuracy_loss.png", dpi=300, bbox_inches='tight')
        plt.show()
        ...
        ax[1].legend()
        plt.savefig("/kaggle/working/EfficientNetB0_roc_pr.png", dpi=300, bbox_inches='tight')
        plt.show()

    def save_final(self):
        self.model.save('/kaggle/working/EfficientNetB0_cifake_final.keras')
        print("✓ Model saved as EfficientNetB0_cifake_final.keras")
        self.model.save('/kaggle/working/EfficientNetB0_cifake_final.h5')
        print("✓ Model saved as EfficientNetB0_cifake_final.h5")
